...
:::: {.column width="25%"}
::: person-card
![](images/headshots/MiguelAcevedo.jpg){.grid-img group="people"} <strong>Miguel Acevedo</strong> [University of Florida]{.inst} <a href="https://www.linkedin.com/in/miguelacevedo" target="_blank" class="social-link"> <i class="bi bi-linkedin"></i> </a> </a>
:::
::::

:::: {.column width="25%"}
::: person-card
![](images/headshots/JoelCorreia.jpg){.grid-img group="people"} <strong>Joel Correia</strong> [Colorado State University]{.inst}
:::
::::

:::: {.column width="25%"}
::: person-card
![](images/headshots/MichaelEsbach.jpg){.grid-img group="people"} <strong>Michael Esbach</strong> [Colorado State University]{.inst}
:::
::::
...
:::: {.column width="25%"}
::: person-card
![](images/headshots/CynthiaSimmons.jpg){.grid-img group="people"} <strong>Cynthia Simmons</strong> [University of Florida]{.inst}
:::
::::

:::: {.column width="25%"}
::: person-card
![](images/headshots/GonzaloRivas.jpg){.grid-img group="people"} <strong>Gonzalo Rivas-Torres</strong> [Univ. San Francisco de Quito]{.inst}
:::
::::
:::::::::::
...
:::: {.column width="25%"}
::: person-card
![](images/headshots/CarlosUrgiles.jpeg){.grid-img group="people"} <strong>Carlos Urgiles</strong> [Colorado State University]{.inst}
:::
::::

:::: {.column width="25%"}
::: person-card
![](images/headshots/RobertWalker.jpeg){.grid-img group="people"} <strong>Robert Walker</strong> [University of Florida]{.inst}
:::
::::
:::::::
